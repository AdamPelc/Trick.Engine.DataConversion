...
mod convert_to_hex {
    ...
    pub fn is_input_data_valid(input_data: &str) -> bool {
    ...
    pub fn allocate_string(input_data_length: usize) -> String {
...
mod test {
    ...
    #[test]
    fn convert_to_hex_lowercase_letters() {
        assert_eq!(
    ...
    #[test]
    fn convert_to_hex_uppercase_letters() {
        assert_eq!(
            convert_to_hex("ABCDEFGHIJKLMNOPQRSTUVWXYZ"),
    ...
    #[test]
    fn convert_to_hex_returned_string_size() {
        // Act
